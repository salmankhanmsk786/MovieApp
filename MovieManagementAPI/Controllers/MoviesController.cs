...
namespace MovieManagementAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        .Include(m => m.Reviews) // Include reviews in the movie response
        ...
        public async Task<IActionResult> AddReview(int movieId, [FromBody] Review review)
        {
            ...
            try
            {
                // Add the review without the movie object
                _context.Reviews.Add(review);
                await _context.SaveChangesAsync();
                return CreatedAtAction(nameof(GetReviews), new { movieId = review.MovieId }, review);
            }
            catch (Exception ex)
            {
